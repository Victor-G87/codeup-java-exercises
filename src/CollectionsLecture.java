...
////
////        String shan = strings.get(0);
////        System.out.println(shan.toUpperCase());
//
//
////        ArrayList<String> strings = new ArrayList<>(Arrays.asList("Justin, "Douglas", "Kenneth"));
