...
//
        ...
        System.out.println("Deploying MIB personnel to counter alien activity!");
         ...
         System.out.println("MIB Officer Larry C. headed to grid area " + matrix[0][1] + "!"); //should say "grid area 7!"
         System.out.println("MIB Officer Kenneth H. headed to grid area " + matrix[2][0] + "!"); //should say "grid area 2!"
